...
import (
	...
	proto "github.com/mavryk-network/mavbingo/v2/protocol/latest"
	...
	testCases := []testCase{
		{
			...
			expect: &protocol.PreattestationSignRequest{
				Chain: &mv.ChainID{0xed, 0x9d, 0x21, 0x7c},
				Branch: &mv.BlockHash{
				...
				Operation: &proto.Preattestation{
					...
					Level: 2,
					Round: 4,
					BlockPayloadHash: &mv.BlockPayloadHash{
			...
			expect: &protocol.BlockSignRequest{
				...
				BlockHeader: proto.UnsignedBlockHeader{
					ShellHeader: core.ShellHeader{
						...
						ValidationPass: 4,
						OperationsHash: &mv.OperationsHash{
					...
					UnsignedProtocolBlockHeader: proto.UnsignedProtocolBlockHeader{
						PayloadHash: &mv.BlockPayloadHash{
						...
						PayloadRound:     0,
						ProofOfWorkNonce: &mv.Bytes8{0xa8, 0xe1, 0xdd, 0x3c, 0x0, 0x0, 0x0, 0x0},
						SeedNonceHash:    mv.None[*mv.CycleNonceHash](),
					},
				},
			},
		},
				...
				Contents: []proto.OperationContents{
					&proto.Transaction{
						ManagerOperation: proto.ManagerOperation{
							Source: &mv.Ed25519PublicKeyHash{
								0xa0, 0xc7, 0xa9, 0xb0, 0xbc, 0xd6, 0xa4, 0x8e, 0xe0, 0xc1, 0x30, 0x94, 0x32, 0x7f, 0x21,
								0x5b, 0xa2, 0xad, 0xea, 0xa7,
							},
							Fee:          mv.BigUint{0xd4, 0xd},
							Counter:      mv.BigUint{0xab, 0xc1, 0xaf, 0x25},
							GasLimit:     mv.BigUint{0xe3, 0x6f},
							StorageLimit: mv.BigUint{0xde, 0x2},
						},
						Amount: mv.BigUint{0xc0, 0x96, 0xb1, 0x2},
		...
		},
		{
			...
			expect: &protocol.GenericOperationSignRequest{
				...
				Contents: []proto.OperationContents{
					...
					&proto.Delegation{
						ManagerOperation: proto.ManagerOperation{
							Source:       &mv.Ed25519PublicKeyHash{0xe1, 0xba, 0x54, 0x49, 0xf2, 0x93, 0x85, 0x68, 0xac, 0xe1, 0x4b, 0x5d, 0xd5, 0x4f, 0x31, 0x93, 0x6d, 0xc8, 0x67, 0x22},
							Fee:          mv.BigUint{0xba, 0x8},
							Counter:      mv.BigUint{0xe0, 0xea, 0xa9, 0x17},
							GasLimit:     mv.BigUint{0xf5, 0x38},
							StorageLimit: mv.BigUint{0x0},
						},
						Delegate: mv.Some[crypt.PublicKeyHash](&mv.Ed25519PublicKeyHash{0x2, 0x29, 0x8c, 0x3, 0xed, 0x7d, 0x45, 0x4a, 0x10, 0x1e, 0xb7, 0x2, 0x2b, 0xc9, 0x5f, 0x7e, 0x5f, 0x41, 0xac, 0x78}),
					},
				},
			},
		},
